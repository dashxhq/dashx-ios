...
#ifndef DASHX_SWIFT_H
#define DASHX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DashX",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("DashXSceneDelegate")
@interface DashXSceneDelegate : UIResponder <UIWindowSceneDelegate>
- (void)sceneDidBecomeActive:(UIScene * _Nonnull)scene SWIFT_AVAILABILITY(ios,introduced=13.0);
/// Forwards custom URL schemes and app-specific URLs opened via the scene through <code>DashXClient/processURL(_:source:forwardToLinkHandler:)</code>.
...
/// Forwards universal links (<code>NSUserActivityTypeBrowsingWeb</code>) to <code>DashXClient.handleUserActivity</code>.
- (void)scene:(UIScene * _Nonnull)scene continueUserActivity:(NSUserActivity * _Nonnull)userActivity SWIFT_AVAILABILITY(ios,introduced=13.0);
