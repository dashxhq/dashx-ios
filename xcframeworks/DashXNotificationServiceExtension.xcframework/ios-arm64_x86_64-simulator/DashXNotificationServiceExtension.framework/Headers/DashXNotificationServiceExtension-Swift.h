...
#ifndef DASHXNOTIFICATIONSERVICEEXTENSION_SWIFT_H
#define DASHXNOTIFICATIONSERVICEEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DashXNotificationServiceExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <ol>
///   <li>
///     Downloads and attaches <code>dashx.image</code> to the notification before display.
///   </li>
///   <li>
///     Registers a <code>UNNotificationCategory</code> for the push’s action buttons (matching the
///     hash the backend stamped into <code>aps.category</code>) so banner long-press reveals them.
///   </li>
///   <li>
///     Fires a <code>trackNotification(event: delivered)</code> GraphQL mutation so analytics records
...
/// <ul>
///   <li>
///     <code>DASHX_BASE_URI</code> — same value as the host app
///   </li>
///   <li>
///     <code>DASHX_PUBLIC_KEY</code> — same value as the host app
///   </li>
/// </ul>
/// If these keys are absent, the NSE skips delivered tracking silently; image attachment
/// and category registration still work.
SWIFT_CLASS("_TtC33DashXNotificationServiceExtension24DashXNotificationService")
@interface DashXNotificationService : UNNotificationServiceExtension
