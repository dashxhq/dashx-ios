...
extension DashXGql {
  class FetchInAppChatConversationQuery: GraphQLQuery {
    static let operationName: String = "FetchInAppChatConversation"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query FetchInAppChatConversation($identityId: UUID!, $conversationId: UUID!) { fetchInAppChatConversation( input: { identityId: $identityId, conversationId: $conversationId } ) { __typename ...ChatConversationSummaryFragment } }"#,
    ...
    struct Data: DashXGql.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("fetchInAppChatConversation", FetchInAppChatConversation.self, arguments: ["input": [
          "identityId": .variable("identityId"),
          "conversationId": .variable("conversationId")
        ]]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        FetchInAppChatConversationQuery.Data.self
      ] }

      var fetchInAppChatConversation: FetchInAppChatConversation { __data["fetchInAppChatConversation"] }

      init(
        fetchInAppChatConversation: FetchInAppChatConversation
      ) {
        self.init(unsafelyWithData: [
          "__typename": DashXGql.Objects.Query.typename,
          "fetchInAppChatConversation": fetchInAppChatConversation._fieldData,
        ])
      }
      ...
      struct FetchInAppChatConversation: DashXGql.SelectionSet {
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          FetchInAppChatConversationQuery.Data.FetchInAppChatConversation.self,
